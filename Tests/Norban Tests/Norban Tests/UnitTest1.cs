...
public class VerifyLinksTest
{
    ...
    */
    ...
    public void verifyHomeButton()
    {
        ...
        Assert.That(driver.FindElement(By.XPath("/html/body/div[1]/main/div/div/section[1]/div/div[1]/h1")).Text, Is.EqualTo("Varför stressa igenom ditt livs största affär?"));
        driver.FindElement(By.CssSelector(".Header-logoPath")).Click();
        Assert.That(driver.FindElement(By.XPath("//*[@id='react - root']/div/section[1]/div/div[1]/p[1]/text()[1]")).Text, Is.EqualTo("Mänskliga mäklare. Digitala möjligheter."));
    }
    [Test]
